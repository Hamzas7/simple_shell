...
/**
 * add_node - appends a node to the list's beginning.
 ...
 * @head: pointer adresse to first node
 * @index: index of the node that has to be removed
 *
 * Return: be 1 when success or be 0 when failure
 */
...
/**
 * free_list - releases every node in a list
